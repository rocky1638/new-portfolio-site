const data = {
  ...
  content: [
    ...
    {
      body: "With this in mind, it should come as no surprise that entering the University of Waterloo as a first year student, I had heard of The Water Boys, and had seen many of their performances on YouTube. However, I would have never expected myself to audition for them, much less go to the semi-finals of an <b>international a capella competition</b> with them."
    },
    {
      body: "In my first term at school, a couple of friends of mine convinced me to join a capella club, and I ended up spending my term with ACE, the non-auditioned group. As the first term flew by, I found myself looking forward to the rehearsals, and by the end of the term, realized that I would miss the singing, the dancing, and most of all, the people."
    },
    {
      body: "It was then that I decided that I would audition for the Water Boys the following term..."
    },
    {
      header: 'the audition',
    },
    {
      body: "To say that I was nervous for my audition would be the <i>understatement of the century.</i> After warming up in the neighboring room for a couple minutes, I was called in, and my audition began with a range check."
    },
    {
      body: "The range check went surprisingly well, considering that I didn't know what to expect. I managed to sing a C5 as my highest upper note, and an E2 as my lowest note. <b>Pretty good!</b>"
    },
    {
